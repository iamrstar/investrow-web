...
export default function DreamHomeGoal() {
  const [currentCost, setCurrentCost] = useState(15000000) // 1.5 Cr default
  ...
  useEffect(() => {
    ...
    // Future cost of the home adjusted for inflation
  ...
  return (
    <GoalLayout title="Dream Home Planner">
      <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-card border border-border p-6 sm:p-8 rounded-2xl shadow-sm space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <label className="font-semibold text-foreground">Current Cost of Dream Home (₹)</label>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <label className="font-semibold text-foreground">Years to Buy</label>
                <span className="text-accent font-bold bg-accent/10 px-4 py-1.5 rounded-xl text-lg">
                  {years} Yr
                </span>
              </div>
            ...
            <div className="grid sm:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <label className="font-semibold text-foreground">Expected Real Estate Inflation</label>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card border border-border p-6 rounded-2xl shadow-sm space-y-4">
            <div>
              <p className="text-sm text-muted-foreground mb-1">Future Cost of Home</p>
