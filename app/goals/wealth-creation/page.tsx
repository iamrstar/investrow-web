...
export default function WealthCreationGoal() {
  const [targetAmount, setTargetAmount] = useState(50000000) // 5 Cr default
  ...
  useEffect(() => {
    ...
    // Future target wealth adjusted for inflation
    const futureValue = targetAmount * Math.pow(1 + infRate, n)
  ...
  }, [targetAmount, years, inflation, expectedReturn])
  ...
  return (
    <GoalLayout title="Wealth Creation Planner">
      <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-card border border-border p-6 sm:p-8 rounded-2xl shadow-sm space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <label className="font-semibold text-foreground">Target Wealth Corpus (Current Value ₹)</label>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <label className="font-semibold text-foreground">Years to Achieve</label>
                <span className="text-accent font-bold bg-accent/10 px-4 py-1.5 rounded-xl text-lg">
                  {years} Yr
                </span>
              </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card border border-border p-6 rounded-2xl shadow-sm space-y-4">
            <div>
              <p className="text-sm text-muted-foreground mb-1">Inflation Adjusted Wealth Corpus</p>
