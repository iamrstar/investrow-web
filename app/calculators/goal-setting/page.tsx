...
export default function GoalSettingCalculator() {
  ...
  useEffect(() => {
    ...
    // Future cost of the goal adjusted for inflation
  ...
  return (
    <CalculatorLayout title="Goal Setting Calculator">
      <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-card border border-border p-6 sm:p-8 rounded-2xl shadow-sm space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <label className="font-semibold text-foreground">Current Cost of Goal (₹)</label>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <label className="font-semibold text-foreground">Years to Goal</label>
                <span className="text-accent font-bold bg-accent/10 px-4 py-1.5 rounded-xl text-lg">
                  {years} Yr
                </span>
              </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card border border-border p-6 rounded-2xl shadow-sm space-y-4">
            <div>
              <p className="text-sm text-muted-foreground mb-1">Inflation Adjusted Goal Target</p>
